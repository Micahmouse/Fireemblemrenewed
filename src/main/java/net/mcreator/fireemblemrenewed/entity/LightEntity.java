...
public class LightEntity extends AbstractArrow implements ItemSupplier {
	public LightEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		super(FireEmblemRenewedModEntities.LIGHT, world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(FireEmblemRenewedModItems.LIGHTELEMENT);
	}
	...
	public static LightEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		LightEntity entityarrow = new LightEntity(FireEmblemRenewedModEntities.LIGHT, entity, world);
	...
	public static LightEntity shoot(LivingEntity entity, LivingEntity target) {
		LightEntity entityarrow = new LightEntity(FireEmblemRenewedModEntities.LIGHT, entity, entity.level);
