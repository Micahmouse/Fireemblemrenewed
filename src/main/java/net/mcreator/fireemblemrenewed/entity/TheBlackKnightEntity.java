...
public class TheBlackKnightEntity extends Monster implements RangedAttackMob {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED,
			ServerBossEvent.BossBarOverlay.PROGRESS);

	public TheBlackKnightEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(FireEmblemRenewedModEntities.THE_BLACK_KNIGHT, world);
	}

	public TheBlackKnightEntity(EntityType<TheBlackKnightEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("The Black Knight"));
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		AlonditeEntity.shoot(this, target);
	}
