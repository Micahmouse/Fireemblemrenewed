...
import net.mcreator.fireemblemrenewed.world.features.plants.FireFlowerFeature;
...
public class FireEmblemRenewedModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(FireFlowerFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.VEGETAL_DECORATION,
				FireFlowerFeature.GENERATE_BIOMES, FireFlowerFeature.CONFIGURED_FEATURE));
	}
